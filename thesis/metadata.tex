...
na syntetických a benchmarkových inštanciách. Práca sa zároveň zameriava na formuláciu úlohy v podobe vhodnej pre dátovo riadené modelovanie založené na predikcii hrán v úplnom grafe.
...
\item navrhnúť a realizovať experimentálny postup zahŕňajúci prípravu syntetických a benchmarkových dát, návrh a trénovanie modelov, ich hodnotenie a analýzu dosiahnutých výsledkov.
\end{itemize}
}