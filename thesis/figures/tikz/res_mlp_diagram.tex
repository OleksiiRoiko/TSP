...
\begin{tikzpicture}[
    ...
    resbox/.style={box, fill=green!8, draw=green!50},
...
%% ── Reziduálny blok (zopakovaný D-krát) ─────────────────────────
...
%% Reziduálna skratka (obchádza blok)
\draw[resarrow]
...
\node[labelbox, anchor=north west] at (3.5, -5.95)
    {\textbf{Dropout:} počas trénovania náhodne
     vypína časť neurónov — znižuje preučenie
     a núti sieť učiť sa robustnejšie vzory.};

\node[labelbox, anchor=north west] at (3.5, -8.70)
    {\textbf{Reziduálna skratka:} sčíta vstup
     bloku s jeho výstupom — umožňuje hlboké
     siete trénovať stabilnejšie.};
